...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, :trainer => { :email => @trainer.email, :firstname => @trainer.firstname, :lastname => @trainer.lastname, :sex => @trainer.sex, :telephone => @trainer.telephone }
    end
  ...
  test "should update trainer" do
    put :update, :id => @trainer, :trainer => { :email => @trainer.email, :firstname => @trainer.firstname, :lastname => @trainer.lastname, :sex => @trainer.sex, :telephone => @trainer.telephone }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
