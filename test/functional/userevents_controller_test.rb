...
class UsereventsControllerTest < ActionController::TestCase
  ...
  test "should create userevent" do
    assert_difference('Userevent.count') do
      post :create, :userevent => { :idevents => @userevent.idevents, :idusers => @userevent.idusers, :quater => @userevent.quater }
    end
  ...
  test "should update userevent" do
    put :update, :id => @userevent, :userevent => { :idevents => @userevent.idevents, :idusers => @userevent.idusers, :quater => @userevent.quater }
    assert_redirected_to userevent_path(assigns(:userevent))
  end
